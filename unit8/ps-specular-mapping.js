...
function createMaterial() {
	...
	var myTexture = THREE.ImageUtils.loadTexture('/media/img/cs291/textures/water.jpg');
	var material = new THREE.MeshPhongMaterial( { shininess: 50,specularMap:myTexture } );
